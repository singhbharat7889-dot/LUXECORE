...
function Home() {
  ...
  const { productItems, status } = useSelector(
    (state) => state.product
  );

  const products = productItems.slice(0, 8);
  ...
  return (
    <>
      ...
      <section className="hero-section position-relative">
        <img
          src="https://images.unsplash.com/photo-1567401893414-76b7b1e5a7a5?q=80&w=870&auto=format&fit=crop"
          alt="Hero Banner"
        ...
        <div className="hero-content">
          ...
          <h1>Premium Clothing Collection</h1>
          ...
          <button
            className="btn btn-light rounded-pill px-4 py-2 fw-bold mt-3"
          ...
          <Row className="g-3">
            <Col xs={12} md={4}>
              <div
                ...
                onClick={() =>
                  handleCategoryClick("Fashion & Apparel")
                }
              >
                <img
      ...
      <div className="offer-bar">
        <p>
          Flat 20% OFF on Women’s Watches – Limited Time!
        </p>
      </div>
      ...
      <div className="container py-5">
        <div className="text-center mb-5">
          ...
          <p className="lead text-muted mx-auto desc">
            Explore our best-selling items, handpicked for quality
            and style.
          </p>
        </div>
      ...
      <div className="container py-5">
        <div className="about-section-wrapper">
          <div className="about-details">
            ...
            <p>
              LuxeCore is a modern lifestyle store providing curated
